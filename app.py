...
intensity_page = st.Page("src/Intensity.py", title="Intensity", icon=":material/percent:")
...
# Simulation results
simul_page = st.Page("src/Simulation.py", title="Prediction", icon=":material/clock_arrow_up:")
