...
cpy_to = "data/pokojna_test.json"
cpy_from = "data/test_project.json"
result = "data/pokojna_test_v2.json"

cpy_to_trees = iou.load_project_json(cpy_to)
cpy_from_trees = iou.load_project_json(cpy_from)

cpy_to_trees["light_avail"] = cpy_from_trees["alight_avail"]
cpy_to_trees["light_comp"] = cpy_from_trees["light_comp"]

write_json(cpy_to, cpy_to_trees, result)
